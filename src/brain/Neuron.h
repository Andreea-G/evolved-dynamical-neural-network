...
const float MAX_STRENGTH = 100;		//TODO find better way to define this somewhere...
const float MAX_ACTIVATION = 100;		//TODO find better way to define this somewhere...
...
public:
	...
	friend bool ActivationFunction(const Neuron &neur);
